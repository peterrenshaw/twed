...
Elm.Main.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var httpTask = $Http.getString("http://192.168.1.2:8090/");
   ...
   var modelAndFxSignal = function () {
      var initial = {ctor: "_Tuple2",_0: "-",_1: $Effects.none};
      var modelAndFx = F2(function (action,_p1) {
         var _p2 = _p1;
         return A2(update,action,_p2._0);
      });
      var modelAndManyFxs = F2(function (actions,_p3) {
         var _p4 = _p3;
         return A3($List.foldl,
         modelAndFx,
   ...
   var main = A2($Signal.map,view(oneActionAddress),modelSignal);
   var NoOp = {ctor: "NoOp"};
